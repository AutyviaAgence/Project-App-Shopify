  ...
  return (
      ...
      childrenEn={
        <>
          ...
          <p>
            ...
            trial, an active subscription is required to continue using the features. Each plan includes a
            defined volume of conversations and AI tokens, indicated on the pricing page.
          </p>
          ...
          <p>
            The User configures the platform themselves and is solely responsible for the results obtained.
            Xeyo cannot be held liable for incorrect configuration.
          </p>
          ...
          <ul>
            ...
            <li>Results obtained from the configuration carried out by the User</li>
          </ul>
    ...
    >
      ...
      <p>
        ...
        l&apos;essai, un abonnement actif est requis pour continuer à utiliser les fonctionnalités. Chaque forfait
        inclut un volume de conversations et de tokens IA défini, indiqué sur la page de tarification.
      </p>
      ...
      <p>
        L&apos;Utilisateur configure lui-même la plateforme et est seul responsable des résultats obtenus.
        Xeyo ne peut être tenu responsable d&apos;une mauvaise configuration.
      </p>
      ...
      <ul>
        ...
        <li>Des résultats obtenus à partir de la configuration réalisée par l&apos;Utilisateur</li>
      </ul>
