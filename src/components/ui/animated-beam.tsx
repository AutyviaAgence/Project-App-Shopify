...
/**
 * AnimatedBeam (Magic UI) — trace un faisceau lumineux courbe entre deux
 * éléments (fromRef → toRef) avec un gradient qui voyage le long du chemin.
 */
